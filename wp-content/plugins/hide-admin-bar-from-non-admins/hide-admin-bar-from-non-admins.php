...
function habfna_disable_admin_bar()  {
  ...
  if (MeuSitePrefs::getInstance()->getPref('ENV') == 'DESENV')  {
     $capability = 'edit_published_posts'; // Author can edit_published_posts
  }
  /* my_log_append('linha = ' . __LINE__ . ' do arquivo ' . __FILE__ . ' capability = ' . $capability); */
